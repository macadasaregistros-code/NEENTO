  ...
  ja_es: {
    ...
    copy: {
      auth: {
        ...
        login: "Login",
        loginDescription:
          "Usa email y contraseña. Tu progreso queda ligado a tu cuenta; las tarjetas agregadas se comparten por modo.",
      ...
      sync: {
        ...
        loginForPersistence: "Tu progreso se guarda en este dispositivo.",
      ...
      vocabulary: {
        ...
        formSupportLabel: "Español",
        formSupportPlaceholder: "donde esta el baño?",
        library: "biblioteca",
        loginDescription: "Crea tarjetas personalizadas para este modo.",
        privateDescription:
          "Crea tarjetas personalizadas para este modo. Ambos usuarios pueden verlas.",
        search: "Buscar vocabulario",
        searchPlaceholder: "Buscar palabra, frase o categoria",
        title: "Vocabulario",
        type: "Tipo",
        userCards: "Palabras agregadas",
      },
    },
  },
  ko_es: {
    ...
    copy: {
      auth: {
        ...
        login: "로그인",
        loginDescription:
          "이메일과 비밀번호로 로그인하세요. 학습 기록은 계정에 저장되고 추가 단어는 모드별로 공유됩니다.",
        loginTitle: "계정으로 로그인",
        logout: "로그아웃",
        password: "비밀번호",
        signInCta: "로그인",
      ...
      vocabulary: {
        ...
        formPrimaryPlaceholder: "donde esta el baño?",
        ...
        library: "단어장",
        loginDescription: "이 모드에 공용 카드를 추가하려면 로그인하세요.",
        privateDescription:
          "이 모드의 공용 카드를 만드세요. 두 사용자 모두 볼 수 있습니다.",
        search: "단어장 검색",
